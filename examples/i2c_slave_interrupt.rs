...
const INIT_VAL: AtomicU8 = AtomicU8::new(0); 
static ARR: [AtomicU8; ARR_LEN] = [INIT_VAL; ARR_LEN]; // Note: in newer compiler versions we can just do `= [const {AtomicU8::new(0)}; ARR_LEN]` instead.
