...
//! Pins used:
//! 
//! SAC0: {OA+: `P1.3`, OA-: `P1.2`, OAO: `P1.1`}
//! 
//! SAC1: {OA+: `P1.7`, OA-: `P1.6`, OAO: `P1.5`}
//! 
//! SAC2: {OA+: `P3.3`, OA-: `P3.2`, OAO: `P3.1`}
//! 
//! SAC3: {OA+: `P3.7`, OA-: `P3.6`, OAO: `P3.5`}

use core::marker::PhantomData;
use crate::{hw_traits::sac::{MSel, NSel, PSel, SacPeriph}, pmm::InternalVRef};

/// The Digital to Analog Converter inside a SAC module.
#[derive(Debug)]
...
/// Struct representing a configuration for a DAC inside a Smart Analog Combo (SAC) unit.
...
impl<SAC: SacPeriph> DacConfig<SAC> {
    ...
    pub fn configure(self, vref: DacRef, load_trigger: DacLoadTrigger) -> Dac<SAC> {
...
pub enum DacRef<'a> {
    ...
    IntRef(&'a InternalVRef),
}
impl From<DacRef<'_>> for bool {
    fn from(value: DacRef) -> Self {
        match value {
            DacRef::Vcc         => false,
            DacRef::IntRef(_)   => true,
        }
    }
}
...
pub enum PositiveInput<'a, SAC: SacPeriph> {
    ...
    /// Internal DAC
    Dac(&'a Dac<SAC>),
    /// Output of the paired SAC opamp
    PairedOpamp,
}
impl<SAC: SacPeriph> PositiveInput<'_, SAC> {
    fn psel(&self) -> PSel {
        match self {
            PositiveInput::ExtPin(_)      => PSel::ExtPinPlus,
            PositiveInput::Dac(_)         => PSel::Dac,
            PositiveInput::PairedOpamp    => PSel::PairedOpamp,
        }
    }
}

/// List of possible sources for the amplifier inverting input
#[derive(Debug)]
...
impl SacConfig {
    ...
    pub fn begin_config<SAC: SacPeriph>(_reg: SAC) -> (DacConfig<SAC>, AmpConfig<NoModeSet, SAC>) {
        todo!()
    }
}
...
impl<SAC:SacPeriph> AmpConfig<NoModeSet, SAC> {
    ...
    pub fn opamp(&mut self, pos_in: PositiveInput<SAC>, neg_in: NegativeInput<SAC>, power_mode: PowerMode) -> AmpConfig<ModeSet, SAC> {
    ...
    pub fn inverting_amplifier(&mut self, pos_in: PositiveInput<SAC>, neg_in: NegativeInput<SAC>, gain: InvertingGain, power_mode: PowerMode) -> AmpConfig<ModeSet, SAC> {
    ...
    pub fn noninverting_amplifier(&mut self, pos_in: PositiveInput<SAC>, gain: NonInvertingGain, power_mode: PowerMode) -> AmpConfig<ModeSet, SAC> {
    ...
    pub fn buffer(&mut self, source: PositiveInput<SAC>, power_mode: PowerMode) -> AmpConfig<ModeSet, SAC> {
